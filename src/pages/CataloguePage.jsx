  ...
  return (
    <main className="py-10">
      <SEO
        ...
        description="Lihat katalog sepeda listrik dan motor listrik CV Chandra Putra Jaya. Tersedia berbagai pilihan merek seperti Exotic, Pacific, Uwinfly, Selis, Saige, Nuv, Larizz, dan lainnya untuk area Surabaya, Lumajang, dan Lombok."
      />
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_0.95fr] lg:items-end">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base leading-8 text-slate-300">
                Jelajahi katalog sepeda listrik dan motor listrik CV Chandra
                Putra Jaya berdasarkan merek, jenis kendaraan, fitur utama, dan
                kebutuhan penggunaan. CPJ berkantor pusat di Surabaya dan
                melayani area Lumajang serta Lombok.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              ...
              <p className="max-w-xl text-sm leading-6 text-slate-600">
                Gunakan pencarian, merek, jenis, fitur, dan urutan harga untuk
                menjelajahi katalog showroom dengan lebih cepat.
              </p>
            </div>
          ...
          <div className="relative mt-8 overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-950 p-8 text-center shadow-xl">
            ...
            <div className="relative mx-auto max-w-xl">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-300">
                Coba ubah kata kunci, merek, jenis produk, fitur, atau urutan
                yang dipilih untuk melihat produk lain di katalog showroom.
              </p>
