...
const contactCards = [
  {
    title: "Tanya Produk",
    description:
      "Tanyakan detail produk seperti stok, warna tersedia, harga terbaru, dan rekomendasi model.",
  ...
  },
  {
    title: "Info Katalog",
    description:
      "Cek informasi katalog berdasarkan merek, model, jenis kendaraan, atau fitur utama.",
  ...
  },
  {
    ...
    description:
      "Hubungi tim kami untuk bertanya lebih lanjut sebelum melihat atau memilih produk.",
    action: "Hubungi Tim",
    href: createWhatsAppLink(
...
function ContactPage() {
        ...
        <section className="relative overflow-hidden rounded-[2rem] bg-slate-950 p-8 text-white shadow-xl lg:p-10">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-end">
            <SectionHeader
              ...
              description="Hubungi tim CV Chandra Putra Jaya untuk menanyakan stok, warna tersedia, harga terbaru, atau rekomendasi produk dari katalog showroom."
            ...
            <div className="rounded-3xl border border-white/10 bg-white/10 p-6 backdrop-blur">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-300">
                ...
                membantu pengecekan informasi produk dengan lebih cepat.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="relative">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                ...
                diminati agar pengecekan stok, warna, dan harga terbaru bisa
  ...
  <div className="relative">
    ...
    <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-950">
      Area lokasi CV Chandra Putra Jaya
    </h2>

    <p className="mt-4 max-w-3xl leading-7 text-slate-600">
      Berikut daftar lokasi yang tercantum dalam katalog perusahaan. Untuk
      ketersediaan produk dan informasi terbaru, hubungi tim terlebih dahulu.
    </p>
